...
**NOTE: work-in-progress!**  If you note any errors in this doc, please [open an issue](https://github.com/covidatlas/li/issues/new/choose), notify us on Slack, or update the docs with a Pull Request.  Thanks!
