 ...
 */
function asRows (data, rowTolerance = 1) {
  const output = []
  let rows = {}
 ...
 *                  value to be considered as being part of the same word, defaults to 1 unit
 */
function asWords (data, rowTolerance = 1, wordTolerance = 1) {
...
function euclideanDistance (a, b) {
  return Math.sqrt((a.x + a.w / 2 - b.x - b.w / 2) ** 2 + (a.y - b.y) ** 2)
}
 ...
 */
function getNearest (target, data) {
  return data
