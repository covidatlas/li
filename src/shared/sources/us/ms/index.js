// Migrated from coronadatascraper, src/shared/scrapers/US/MS/index.js
...
function _fixCountyTypos (county) {
  let fixed = county
...
const stateUrl = 'https://msdh.ms.gov/msdhsite/_static/14,0,420.html'
...
module.exports = {
  ...
  scrapers: [
    {
      // TODO (scrapers) fix us-ms start date
