  ...
  scrapers: [
    {
      ...
      crawl: [
        {
          ...
          url: () => {
            ...
            const url = `https://coronavirus.gob.mx/datos/Downloads/Files/Casos_Diarios_Estado_Nacional_Defunciones_${yyyymmdd}.csv`
            return { url }
          }
        }
      ],
      scrape (rawdata, date) {
        ...
        const result = states.map(s => {
          const deaths = dailies.filter(d => d.name === s).
