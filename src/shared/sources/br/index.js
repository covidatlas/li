// Migrated from coronadatascraper, src/shared/scrapers/BR/index.js

const { join } = require('path')
const srcShared = join(__dirname, '..', '..') + '/'
...
module.exports = {
  ...
  scrapers: [
    ...
    {
      // TODO (scraper): things actually broke before this point, move this date back to where it actually worked.
